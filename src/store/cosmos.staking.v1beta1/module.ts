...
export const txClient = (
  ...
  return {
    async sendMsgNewRegion({
      ...
      if (!signer) {
        throw new Error(
          "TxClient:sendMsgNewRegion: Unable to sign Tx. Signer is not present."
        );
      }
      try {
        ...
        throw new Error(
          "TxClient:sendMsgNewRegion: Could not broadcast Tx: " + e.message
        );
      }
    },
    ...
    async sendMsgNewKyc({
      ...
      fee,
      memo,
    }: sendMsgNewKycParams): Promise<DeliverTxResponse> {
      if (!signer) {
        throw new Error(
          "TxClient:sendMsgNewKyc: Unable to sign Tx. Signer is not present."
        );
      }
      try {
        const { address } = (await signer.getAccounts())[0];
        ...
        throw new Error(
          "TxClient:sendMsgNewKyc: Could not broadcast Tx: " + e.message
        );
      }
    },
    ...
    async sendMsgStake({
      ...
      fee,
      memo,
    }: sendMsgStakeParams): Promise<DeliverTxResponse> {
      if (!signer) {
        throw new Error(
          "TxClient:sendMsgStake: Unable to sign Tx. Signer is not present."
        );
      }
      try {
        const { address } = (await signer.getAccounts())[0];
        ...
        throw new Error(
          "TxClient:sendMsgStake: Could not broadcast Tx: " + e.message
        );
      }
    },
    ...
    async sendMsgUnstake({
      value,
      fee,
      memo,
    }: sendMsgUnstakeParams): Promise<DeliverTxResponse> {
      if (!signer) {
        throw new Error(
          "TxClient:sendMsgUnstake: Unable to sign Tx. Signer is not present."
        );
      }
      try {
        const { address } = (await signer.getAccounts())[0];
        ...
        throw new Error(
          "TxClient:sendMsgUnstake: Could not broadcast Tx: " + e.message
        );
      }
    },

    async sendMsgDoFixedWithdraw({
      value,
      memo,
    }: sendMsgDoFixedWithdrawParams): Promise<DeliverTxResponse> {
      if (!signer) {
        throw new Error(
          "TxClient:sendMsgDoFixedWithdraw: Unable to sign Tx. Signer is not present."
        );
      }
      try {
        const { address } = (await signer.getAccounts())[0];
        ...
        let msg = this.msgDoFixedWithdraw({
          value: MsgDoFixedWithdraw.fromPartial(value),
        });
        ...
        throw new Error(
          "TxClient:sendMsgDoFixedWithdraw: Could not broadcast Tx: " +
            e.message
        );
      }
    },
    ...
    async sendMsgDoFixedDeposit({
      value,
      memo = "",
    }: sendMsgDoFixedDepositParams): Promise<DeliverTxResponse> {
      if (!signer) {
        throw new Error(
          "TxClient:sendMsgDoFixedDeposit: Unable to sign Tx. Signer is not present."
        );
      }
      try {
        const { address } = (await signer.getAccounts())[0];
        ...
        let msg = this.msgDoFixedDeposit({
        ...
        throw new Error(
          "TxClient:sendMsgDoFixedDeposit: Could not broadcast Tx: " + e.message
        );
      }
    },
    ...
    async sendMsgRemoveRegion({
      ...
      if (!signer) {
        throw new Error(
          "TxClient:sendMsgRemoveRegion: Unable to sign Tx. Signer is not present."
        );
      }
      try {
        const { address } = (await signer.getAccounts())[0];
        ...
        throw new Error(
          "TxClient:sendMsgRemoveRegion: Could not broadcast Tx: " + e.message
        );
      }
    },
    ...
    async sendMsgSetFixedDepositInterestRate({
      ...
      if (!signer) {
        throw new Error(
          "TxClient:sendMsgSetFixedDepositInterestRate: Unable to sign Tx. Signer is not present."
        );
      }
      try {
        const { address } = (await signer.getAccounts())[0];
        ...
        let msg = this.msgSetFixedDepositInterestRate({
        ...
        throw new Error(
          "TxClient:sendMsgSetFixedDepositInterestRate: Could not broadcast Tx: " +
            e.message
        );
      }
    },

    async sendMsgRemoveKyc({
      value,
      fee,
      memo,
    }: sendMsgRemoveKycParams): Promise<DeliverTxResponse> {
      if (!signer) {
        throw new Error(
          "TxClient:sendMsgRemoveKyc: Unable to sign Tx. Signer is not present."
        );
      }
      try {
        const { address } = (await signer.getAccounts())[0];
        ...
        throw new Error(
          "TxClient:sendMsgRemoveKyc: Could not broadcast Tx: " + e.message
        );
      }
    },
    ...
    msgNewRegion({ value }: msgNewRegionParams): EncodeObject {
      try {
        return {
          typeUrl: "/cosmos.staking.v1beta1.MsgNewRegion",
          value: MsgNewRegion.fromPartial(value),
        };
      } catch (e: any) {
        throw new Error(
          "TxClient:MsgNewRegion: Could not create message: " + e.message
        );
      }
    },
    ...
    msgNewKyc({ value }: msgNewKycParams): EncodeObject {
      try {
        return {
          typeUrl: "/cosmos.staking.v1beta1.MsgNewKyc",
          value: MsgNewKyc.fromPartial(value),
        };
      } catch (e: any) {
        throw new Error(
          "TxClient:MsgNewKyc: Could not create message: " + e.message
        );
      }
    },
    ...
    msgStake({ value }: msgStakeParams): EncodeObject {
      try {
        return {
          typeUrl: "/cosmos.staking.v1beta1.MsgStake",
          value: MsgStake.fromPartial(value),
        };
      } catch (e: any) {
        throw new Error(
          "TxClient:MsgStake: Could not create message: " + e.message
        );
      }
    },
    ...
    msgUnstake({ value }: msgUnstakeParams): EncodeObject {
      try {
        return {
          typeUrl: "/cosmos.staking.v1beta1.MsgUnstake",
          value: MsgUnstake.fromPartial(value),
        };
      } catch (e: any) {
        throw new Error(
          "TxClient:MsgUnstake: Could not create message: " + e.message
        );
      }
    },
    ...
    msgDoFixedWithdraw({ value }: msgDoFixedWithdrawParams): EncodeObject {
      try {
        return {
          typeUrl: "/cosmos.staking.v1beta1.MsgDoFixedWithdraw",
          value: MsgDoFixedWithdraw.fromPartial(value),
        };
      } catch (e: any) {
        throw new Error(
          "TxClient:MsgDoFixedWithdraw: Could not create message: " + e.message
        );
      }
    },
    ...
    msgDoFixedDeposit({ value }: msgDoFixedDepositParams): EncodeObject {
      try {
        return {
          typeUrl: "/cosmos.staking.v1beta1.MsgDoFixedDeposit",
          value: MsgDoFixedDeposit.fromPartial(value),
        };
      } catch (e: any) {
        throw new Error(
          "TxClient:MsgDoFixedDeposit: Could not create message: " + e.message
        );
      }
    },
    ...
    msgRemoveRegion({ value }: msgRemoveRegionParams): EncodeObject {
      try {
        return {
          typeUrl: "/cosmos.staking.v1beta1.MsgRemoveRegion",
          value: MsgRemoveRegion.fromPartial(value),
        };
      } catch (e: any) {
        throw new Error(
          "TxClient:MsgRemoveRegion: Could not create message: " + e.message
        );
      }
    },
    ...
    msgSetFixedDepositInterestRate({
      value,
    }: msgSetFixedDepositInterestRateParams): EncodeObject {
      try {
        return {
        ...
        throw new Error(
          "TxClient:MsgSetFixedDepositInterestRate: Could not create message: " +
            e.message
        );
      }
    },
    ...
    msgRemoveKyc({ value }: msgRemoveKycParams): EncodeObject {
      try {
        return {
          typeUrl: "/cosmos.staking.v1beta1.MsgRemoveKyc",
          value: MsgRemoveKyc.fromPartial(value),
        };
      } catch (e: any) {
        throw new Error(
          "TxClient:MsgRemoveKyc: Could not create message: " + e.message
        );
      }
    },
